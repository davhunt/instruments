...
### 0.08
* Addition of ABQ, ATS, BSTAD, CASI, CBCL (unscored), CYBER, DEMO_D, DERSP(ES), DYADA/B, EATQ(ES), ERQCA, FASAP(ES), FPEP(ES), IDENTITYA, INFOSHT(ES), INITSTATEC/D, MSS, OCIC, OOPJR, PBS/P(ES), PDSF(P)(ES)_B, PDSMP(ES), PHYSINFO/P(ES), POSTTASKE/F, RPBIC/P(ES), RSRI/P(ES), SASSY, SCAREDPES, SELFNOWA, SOCREW, SWCQ, TSIS, TXRXA(ES), VIA, YSSM/P(ES)
