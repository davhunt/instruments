...
### 0.08
* Addition of ABQ, ATS, BFNEES, BSTAD, CASI, CBCL (unscored), CYBER, DEMO_D, DERSP(ES), DSMXC, DYADA/B, EATQ(ES), ERQCA, ERQES, FASAP(ES), FPEES, FPEP(ES), IDENTITYA, INFOSHT(ES), INITSTATEC/D, MASIES, MSS, OCIC, OOPJR, PBS/P(ES), PDS(P)(ES), PHYSINFO/P(ES), PINTSES, POSTTASKE/F, PSS(ES), RCADS, RPBIC/P(ES), RSRI/P(ES), SASSY, SCAAREDES, SCAREDPES, SELFNOWA, SOCREW, SWCQ, TEXIP(ES), TSIS, TXRXA(ES), VIA(ES), YSSM/P(ES)
