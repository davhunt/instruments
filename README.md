...
### 0.08
* Addition of ABQ, ATS, BSTAD, CASI, CYBER, DEMO_D, DYADA/B, EATQ(ES), ERQCA, FASAP(ES), FPE, IDENTITYA, INFOSHT(ES), INITSTATEC/D, MSS, OCIC, OOPJR, PBS/P(ES), PDSF(P)(ES)_B, PDSMP(ES), PHYSINFO/P(ES), POSTTASKE/F, SASSY, SCAREDPES, SOCREW, SWCQ, TSIS, TXRXA(ES), VIA, YSSM/P(ES)
