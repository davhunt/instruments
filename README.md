...
### 0.08
* Addition of ABQ, ATS, BSTAD, CASI, CYBER, DEMO_D, DYADA/B, EATQ(ES), ERQCA, FPE, IDENTITYA, INFOSHT(ES), INITSTATEC/D, MSS, OCIC, OOPJR, PHYSINFO/P(ES), POSTTASKE/F, YSSM/P(ES)
