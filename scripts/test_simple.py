...
def test_simple_scoring(simple_data_single):
    # unpack simple_data
    surv_data, input_path, solutions = simple_data_single
...
def test_simple_mult_scoring(simple_data_multiple):
    # unpack simple_data
    surv_data, input_path, solutions = simple_data_multiple
    sol_cols = list(solutions.columns)
    # generate data using json_scorer, an interface to call survey
    output_data = jscore.json_score(input_path, surv_data)
